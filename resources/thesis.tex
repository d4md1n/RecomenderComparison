...
\pagenumbering{gobble}
	\begin{titlepage}
		...
		\vspace{2cm}
		{\bfseries Σύγκριση Συστημάτων Προτάσεων\par}
		\vfill
...
\end{center}
\newpage
%\paragraph{}universtity of piraeus department of digital systems postgraduate program on Digital systems and services. Vasileios Simeonidis
\chapter*{Preface}
